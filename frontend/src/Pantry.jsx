  ...
  return (
    <div className="picker">
      ...
      {picker.status === "done" && picker.results.length === 0 && (
        <p className="status">No matches. Try simpler words, like "egg whole raw".</p>
      )}
  ...
  return (
    <main className="app">
      ...
      {loading ? (
        ...
        <p className="empty">Nothing here yet. Add what you bought, like chicken breast, 3 lb.</p>
      ) : (
      ...
      <section className="meals">
        ...
        {meals.length === 0 && mealStatus !== "loading" && !mealError && (
          <p className="status">Get three meal ideas built from what's in your pantry.</p>
        )}
        {meals.length > 0 && (
